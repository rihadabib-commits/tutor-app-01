...
//               <div>
//                    <Button variant="outline" onClick={handleGoogleSingIn} className="w-full rounded-none">
      ...
      <div className="login-page">
        <div className="login-box">
          ...
          <div className="login-left">
            ...
            <div>
              <div style={{ fontSize: "19px", color: "#fff", lineHeight: "1.7" }}>
                Education is the passport to the future
              </div>
              <div style={{ fontSize: "12px", color: "#5DCAA5", marginTop: "10px" }}>
                — Malcolm X
              </div>
            </div>
          </div>
          ...
          <div className="login-right">
            ...
            {/* Google Button */}
            <button type="button" onClick={handleGoogleSignIn} className="login-btn-google">
            ...
            <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ textAlign: "right", marginTop: "-8px" }}>
                <a href="#" style={{ fontSize: "12px", color: "#1D9E75", textDecoration: "none" }}>
                  Forgot password?
                </a>
              </div>
