...
// import ThemeToggle from "@/components/ThemeToggle"; // ✅ এইটা যোগ করো
...
//         </div>
//         <div>
//           <h1 className="text-3xl font-bold text-purple-600">MediQueue</h1>
//           <p className="text-sm text-gray-500">Tutor Booking System</p>
//         </div>
//       </div>
...
//             </Avatar>
//             <Button onClick={handleSingOut} variant="danger" className="rounded-none">
//               Logout
//             </Button>
//           </div>
//         ) : (
//           <div className="flex items-center gap-3">
//             <Link href="/login">
//               <button className="px-6 py-2 border rounded-xl hover:bg-gray-100">Login</button>
//             </Link>
//             <Link href="/singup">
//               <button className="px-6 py-2 bg-purple-600 text-white rounded-xl hover:bg-purple-700">Register</button>
//             </Link>
//           </div>
//         )}
//       </div>
